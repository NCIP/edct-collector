...
<div id="page" class="page <?php print change_uri(request_uri()); ?>">
        ...
        <?php if ($logo || $site_name || $site_slogan || $header): ?>
          ...
          <?php if ($logo || $site_name || $site_slogan): ?>
            <div id="header-site-info" class="header-site-info block">
              ...
              <?php if ($logo): ?>
                <div id="logo">
                  <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><img
              ...
              <?php if ($site_name || $site_slogan): ?>
                ...
                <?php if ($site_name): ?>
                  <span id="site-name"><a href="<?php print check_url($front_page); ?>"
                      ...
                      <div id="content-region" class="content-region row nested">
                        <div id="content-region-inner" class="content-region-inner inner clearfix">
                          <?php if($content_top_left): ?>
                            <div id="content-top-left" class="content-top-left"><div id="content-top-left-inner" class="content-top-left-inner inner clearfix">
                          ...
                          <div id="content-inner" class="content-inner block">
                            <div id="content-inner-inner" class="content-inner-inner inner clearfix">
                              <h1>Username and Password Retrieval</h1>
                              <span class="form-req"><span>*</span>Required</span>
                            <?php if ($content): ?>
