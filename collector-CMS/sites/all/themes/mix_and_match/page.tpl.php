<?php
// $Id: page.tpl.php,v 1.1 2010/10/26 23:22:22 aross Exp $
?>
...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page <?php print $page_color; ?>">
   ...
   <?php if ($logged_in): ?>
    <h2 id="user-name-top">Hello <?php print l(getName($user->uid), 'user/edit'); ?></h2>
                      ...
                      <div id="content-group-inner" class="content-group-inner inner">
                        ...
                        <div id="content-region" class="content-region row nested">
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <?php print theme('grid_row_mm', $tabs, 'content-tabs'); ?>
