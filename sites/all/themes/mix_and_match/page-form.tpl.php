...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xform="http://www.w3.org/2002/xforms" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>">
...
<body id="xform-page" class="<?php print $body_classes; ?>">
  <div id="page" class="page <?php print $page_color; ?> page-forms">
        ...
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            <div class="header-group-container">
                ...
                <div id="header-site-info" class="header-site-info block <?php print $title_color.' '.$slogan_color; ?>">
                  ...
                  <div id="main-content-inner" class="main-content-inner inner">
                    ...
                    <div id="content-group" class="content-group row nested <?php print $content_group_width; ?>">
                      <div id="content-group-inner" class="content-group-inner inner">
                        ...
                        <div id="xform-block" class="xform-block auto-width block block-<?php echo $xml['block_id']?>"><div class="xform-block-inner"><?php  echo  $xml['body']?></div></div>
