...
-->
		...
		<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="xhtml:html | html">
			...
			<html xmlns="http://www.w3.org/1999/xhtml">
				<xsl:copy-of select="@*"/>
				<xsl:comment>HTML elements and Javascript instructions generated by XSLTForms Beta3 - Copyright (C) 2008-2011 &lt;agenceXML&gt; - Alain COUTHURES - http://www.agencexml.com</xsl:comment>
